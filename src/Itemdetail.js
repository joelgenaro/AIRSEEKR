...
export default class Itemdetail extends Component {
    ...
    processPayment  = async () => {
        ...
        if (user_details != null) {
            ...
            var order_id = 0;
            var amount = offer.total_amount_pay;
            // var amount = 5
                    ...
                    <View style={{ flex: 1, backgroundColor: Colors.whiteColor, paddingBottom: windowHeight * 2 / 100 }}>
                        ...
                        {this.state.offer_by_me == true && <View>
                            ...
                            {(this.state.product_detail != 'NA' && this.state.product_detail.for_sale == 1) && <View>
                                ...
                                {(this.state.product_detail.offer_details && this.state.product_detail.offer_details.status == 1 && !this.state.product_detail.offer_details.transfer_id) &&
                                <>
