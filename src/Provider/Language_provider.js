...
sharelinktitle=['MyBoat App Link','MyBoat App Link']
  ...
  msgConfirmTextdelete = ['Are you sure you want to delete?', 'Are you sure you want to delete?']
...
verification1 = ['Please type the verification code sent to mail and please check your junk folder','']
verify = ['Verify','']
resend=['Resend','']
edit=['Edit','']
otp=['OTP','']
adscategory=['Ads Categories','']
viewall=['View all','View all']

recentAds1=['What people are seeking:','What people are seeking:']
...
txtAllListing=["What People Are Seeking",'']
txtDetail=["Details",'']
